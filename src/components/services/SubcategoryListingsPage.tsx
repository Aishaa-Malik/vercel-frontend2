...
const subcategoryListings: Record<string, Record<string, Listing[]>> = {
  ...
  gyms: {
    'fun-workout': [
      ...
      { id: 'fw-6', name: 'Sweatbox Gym', location: 'Raja Park, Jaipur', thumb: 'https://lh3.googleusercontent.com/p/AF1QipN4ORSvcvxZBpkSg9dTOlbslHFrhRgmKH1CVwgl=s1360-w1360-h1020-rw', details: 'Central Park', rating: 4.8, reviewCount: 74 },
      { id: 'fw-7', name: 'Fit Arena Gym', location: 'Vidyadar Nagar, Jaipur', thumb: 'https://img.fitimg.in/studio_profile_46256E619E41BE.png', details: 'Central Park', rating: 4.5, reviewCount: 56 },
      { id: 'fw-8', name: 'Fitness Connection', location: 'Raja Park, Jaipur', thumb: 'https://lh3.googleusercontent.com/p/AF1QipMCJ78ZGMoyZ-1lCdTqN3Hij82Y0vPL-j0NtlfR=s1360-w1360-h1020-rw', details: 'Central Park', rating: 4.3, reviewCount: 29 },
