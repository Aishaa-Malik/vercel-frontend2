...
const subcategoryListings: Record<string, Record<string, Listing[]>> = {
  ...
  gyms: {
    'fun-workout': [
      ...
      { id: 'fw-6', name: 'Sweatbox Gym', location: 'Central Park, Jaipur', thumb: 'https://lh3.googleusercontent.com/p/AF1QipN4ORSvcvxZBpkSg9dTOlbslHFrhRgmKH1CVwgl=s1360-w1360-h1020-rw', details: 'Central Park', rating: 4.2, reviewCount: 34 },
