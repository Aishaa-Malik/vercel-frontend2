    ...
    <div className={`min-h-screen relative flex items-center justify-center ${darkMode ? 'dark bg-gray-900' : 'bg-gray-100'}`}>
      ...
      <div className="lg:hidden relative z-20">
        <div className="absolute inset-0 flex z-40">
          ...
          ></div>
          <div
            className={`relative flex-1 flex flex-col max-w-xs w-full bg-black bg-opacity-70 backdrop-blur-md rounded-3xl border border-gray-700 p-4 m-4 transition ease-in-out duration-300 transform ${
