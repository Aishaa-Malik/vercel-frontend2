...
const subcategoryListings: Record<string, Record<string, Listing[]>> = {
  ...
  gyms: {
    'fun-workout': [
      ...
      { id: 'fw-3', name: 'Group workout & MUSICAL YOGA', location: 'Central Park', thumb: '/images/services/service-2.jpg', details: 'Central Park' },
      { id: 'fw-4', name: 'Eco Fitness dance', location: 'Central Park', thumb: '/dancecp.png', details: 'Central Park' },
      { id: 'fw-5', name: 'RELAXING MEDITATION IN NATURE', location: 'Central Park', thumb: '/meditation.png', details: 'Central Park' },
      { id: 'fw-6', name: 'Sweatbox Gym', location: 'Central Park', thumb: 'https://lh3.googleusercontent.com/p/AF1QipN4ORSvcvxZBpkSg9dTOlbslHFrhRgmKH1CVwgl=s1360-w1360-h1020-rw', details: 'Central Park' },
      { id: 'fw-7', name: 'Fit Arena Gym', location: 'Central Park', thumb: 'https://img.fitimg.in/studio_profile_46256E619E41BE.png', details: 'Central Park' },
      { id: 'fw-8', name: 'Fitness Connection', location: 'Central Park', thumb: 'https://lh3.googleusercontent.com/p/AF1QipMCJ78ZGMoyZ-1lCdTqN3Hij82Y0vPL-j0NtlfR=s1360-w1360-h1020-rw', details: 'Central Park' },
      { id: 'fw-9', name: 'One Rule Gym', location: 'Central Park', thumb: 'https://lh3.googleusercontent.com/gps-cs-s/AG0ilSwhMp7yBIEdzNXrD6TIROue5d4wwUJS57bAtLj1KEdo3jwi_T1A3C2Sgsd3cCktzEm_BYVmq1-iyINNyIghEY8x3NQmyRfIcP2tGeFi88yztsgeJpWsGSEX-SJw1OSS6mPQtTMnvpK-90r8=s1360-w1360-h1020-rw', details: 'Central Park' },
    ],
  },
};
