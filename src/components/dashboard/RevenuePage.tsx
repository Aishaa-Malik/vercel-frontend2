...
const RevenuePage: React.FC = () => {
  ...
  .select(`
    ...
    created_at,
    booking_reference
  `).gte('appointment_date', dateRange.startDate.toISOString()) // Filter by appointment_date instead of created_at
    ...
    .order('appointment_date', { ascending: false }); // Remove date and status filters temporarily
      ...
      if (periodTransactions && periodTransactions.length > 0) {
        ...
        console.log('No transactions found. Checking for any appointments in the table...');
        ...
        console.log('Sample of available appointments:', anyAppointments);
      }
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                From {metrics.appointments} appointments
              </p>
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-gray-900 mt-2">
              {metrics.appointments > 0 
                ? formatCurrency(Math.round(metrics.revenue / metrics.appointments))
                : formatCurrency(0)
              }
            </p>
            <p className="text-sm text-gray-500 mt-1">
        ...
        <div className="mt-6 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg p-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">{metrics.appointments}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">
                {metrics.appointments > 0 ? formatCurrency(Math.round(metrics.revenue / metrics.appointments)) : '₹0'}
              </p>
            </div>
          </div>
        </div>
