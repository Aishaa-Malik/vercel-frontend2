            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                <p className="mt-3 text-base text-blue-100 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Streamline your hospital or clinic's appointment booking process with our WhatsApp integration. Easy for patients, efficient for your staff.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Our platform makes it easy for patients to book appointments and for your staff to manage them efficiently.
            </p>
          </div>
            ...
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">24/7 Booking</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Patients can book appointments anytime, anywhere using WhatsApp - no app download required.
                </dd>
              </div>
              ...
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Automatically suggests available time slots and prevents double bookings.
                </dd>
              </div>
              ...
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Reduce no-shows with automated WhatsApp reminders before appointments.
                </dd>
              </div>
              ...
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Track appointment trends, patient flow, and revenue with our comprehensive dashboard.
                </dd>
              </div>
            </dl>
          </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="mt-8 md:mt-0 md:order-1">
              <p className="text-center text-base text-gray-400">
                &copy; 2025 Toriate, Inc. All rights reserved.
              </p>
            </div>
          </div>
        </div>
