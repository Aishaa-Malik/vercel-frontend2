  ...
  const handleConnectGoogleCalendar = async () => {
    try {
      ...
      googleAuthUrl.searchParams.set('prompt', 'consent'); // Forces refresh_token
       ...
       console.log('Redirect URI being used:', `${window.location.origin}/oauth/callback`); // 🔥 ADD: Debug log
    console.log('Full OAuth URL:', googleAuthUrl.toString()); // 🔥 ADD: Debug log
  ...
  return (
    <div className="p-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-md p-4 mt-4">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <div className={`text-lg font-bold ${(appointmentUsage.total - appointmentUsage.used) > 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
      ...
      <div className="bg-black bg-opacity-80 rounded-lg shadow p-6">
        ...
        <div className="mb-4">
          <h3 className="font-medium mb-2 dark:text-white">Google Calendar</h3>
          ...
          {isGoogleCalendarConnected ? (
            <div>
              <div className="flex items-center">
                ...
                <button 
                  className="ml-4 text-sm text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300"
                  onClick={async () => {
            ...
            <div>
              <button 
                ...
                className="inline-flex items-center bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 px-4 py-2 rounded shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isConnecting ? (
                  <>
