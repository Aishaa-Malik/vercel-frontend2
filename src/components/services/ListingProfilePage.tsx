  ...
  gyms: {
    'fun-workout': {
      ...
      'fw-2': {
        ...
        contact: { phone: '+91 96605 55556', address: 'Bhagat Singh Park, Frontier Colony, Adarsh Nagar, Jaipur, Rajasthan 302004' },
        ratingScore: 4.6,
        ratingCount: 124,
      ...
      'fw-3': {
        ...
        hours: '6 AM – 9 AM',
        pricing: '₹99 per session',
        contact: { phone: '+91 8619439126', address: 'Central Park, Prithviraj Rd, Rambagh, Jaipur, Rajasthan 302015' },
        ratingScore: 4.7,
        ratingCount: 45,
      ...
      'fw-7': {
        ...
        contact: { phone: '+91 8619439126', address: 'Vidyadarnagar, C-7, near Biyani College, L S Nagar, Naya Khera, Vidyadhar Nagar, Jaipur, Rajasthan 302013' },
        ratingScore: 4.5,
        ratingCount: 56,
